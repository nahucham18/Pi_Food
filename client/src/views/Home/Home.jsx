...
const Home = () =>{
    ...
    return (
        <div>
            ...
            <Header/>
            <p className={style.text_p}>En Cheff at House encontraras mas de 100 recetas para poder expandir mas tu conocimientos culinarios. <br />Sumate a nosotros, forma parte de esta comundad gastronomica y demostra que tus platos tambien son unicos. <span className={style.negrita}>A cocinar!</span> </p>
